...
if (isset($_POST['login'])) {
  ...
  if ($remember) {
    // Thiết lập cookie lưu trữ email và password
    setcookie("email", $email, time() + (86400 * 30), "/"); // Lưu trữ trong 30 ngày
    setcookie("password", $password, time() + (86400 * 30), "/"); // Lưu trữ trong 30 ngày
  } else {

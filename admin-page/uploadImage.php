...
function uploadImages($uploadedImages, $takeid)
{
    ...
    $uploadPath = "../image/plants/";
    if (!is_dir($uploadPath)) {
        mkdir($uploadPath);
    }
    $uploadPathThumb = "../image/plants/thumbnail/";
    ...
    foreach ($files as $file) {
        ...
        if ($file != false) {
            ...
            $image = 'image/plants/'  . $file['name'] . '';
            $sql = 'insert into image(plant_id, image_path) values (' . $takeid . ',"' . $image . '")';
            execute($sql);
            //tạo thumbnail
            $thumbnail = "../$image";

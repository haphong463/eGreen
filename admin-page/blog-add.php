...
<body>
    ...
    <section class="dashboard">
        ...
        <table class="table">
            ...
            <div class="container-fluid">
                ...
                <h1>Blog Add</h1>
                <form action="process/blog-add-process.php" class="row" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                    <div class="mb-3 mt-3">
    ...
    <script>
        ...
        function enableAutoGeneratedButtons() {

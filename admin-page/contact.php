...
$sql = "SELECT * FROM contacts_list ORDER BY sent_date desc LIMIT $start, $perPage";
$contact = executeResult($sql);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <section class="dashboard">
            ...
            <div class="container">
                ...
                <tbody id="myTable">
                    ...
                    ?>
                            ...
                            <td><?php echo $c['sent_date'] ?></td>
                            <td><?php echo $c['reply'] ?></td>
                            <td>
                                <a href="contact-sendmail.php?id=<?php echo $c['id'] ?>">
        ...
        <div class="pagination">
            ...
            $sql_count = "SELECT COUNT(*) AS total FROM contacts_list";
